...
__export(index_exports, {
  VKYCErrorCode: () => VKYCErrorCode,
  VKYCPermissionStatus: () => VKYCPermissionStatus,
  checkNetworkStatus: () => checkNetworkStatus,
  getPermissionStatusDescription: () => getPermissionStatusDescription,
  requestCameraAccess: () => requestCameraAccess,
  requestLocationAccess: () => requestLocationAccess,
  requestMicrophoneAccess: () => requestMicrophoneAccess,
  requestVideoAndMicAccess: () => requestVideoAndMicAccess,
  verifyAllPermissions: () => verifyAllPermissions
});
